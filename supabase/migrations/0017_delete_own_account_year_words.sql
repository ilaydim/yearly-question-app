...
-- delete_own_account(): "Yılın Kelimesi" (year_words) eklendiğinden hesap silme akışının
-- da bu tabloyu açıkça temizlemesi gerekiyor (bkz. 0014_delete_own_account.sql'deki
